    ...
    <section className="mil-p-120-0">
        <div className="container mil-p-0-120" id="project">
            ...
            <div className="mil-info mil-up">
                ...
                ))}   <a style={{marginLeft:"-120px"}} data-no-swup href="https://lakshyaspace.in/" target="_blank" className="mil-link mil-dark mil-up mil-arrow-place">
            ...
            {typeof postData.description != "undefined" &&
                ...
                <div className="row justify-content-between mil-p-90-120">
                <div className="col-lg-5">
                    <h3 className="mil-up mil-mb-60">{postData.description2.title}</h3>
                </div>
                <div className="col-lg-6">
                <div className="mil-text mil-up" dangerouslySetInnerHTML={{__html : postData.description2.content}} />
                </div>
